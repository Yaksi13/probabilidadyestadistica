...
anyNA (flores)#Identificar si hay datos perdidos dirÃ¡ True o False
...
#la funciÃ³n que utilizaremos para identificar la moda
# es mfv()
mfv(flores_1$Largo.Sepalo)
mfv(flores_1$Ancho.Sepalo)
mfv(flores_1$Largo.Petalo) #Â¿QuÃ© observas?
mfv(flores_1$Ancho.Petalo)
mfv(flores_1$Especies)#Â¿QuÃ© observas?
...
#calcularemos la desviaciÃ³n standar
